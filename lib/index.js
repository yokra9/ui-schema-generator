...
class UiSchemaGenerator {
    ...
    */
    constructor(jsonSchema) {
        ...
        this.schema = jsonSchema.definitions.Schema
        this.fieldOptions = {}
        this.errorOptions = {}
    }
     ...
     * @param {Object} [fieldOptions] テンプレート内で使う属性に対応するデータオブジェクト。値として function(model) を取ることもできる。 {@link https://vuejs.org/v2/guide/render-function.html#The-Data-Object-In-Depth 公式の説明はこちら}
     ...
     * @returns {UiSchemaGenerator} UiSchemaGenerator
     */
    generate(component, models, fieldOptions, children, displayOptions, errorOptions, errorHandler) {
                ...
                this.uiSchema.push(
                    // uiSchema
                    {
                        ...
                        fieldOptions: _.mergeWith(
                            ...
                            fieldOptions,
                            (obj, src) => {
                                if (typeof src == "function") return src(model)
                            }
                        ),
                        children,
                        displayOptions,
